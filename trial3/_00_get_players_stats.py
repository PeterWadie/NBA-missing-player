...
def get_players_stats(year):
    ...
    for idx, row in df.iterrows():
        ...
        for h_player in home_players:
            update_player_stats(
                h_player, is_home=True, outcome=outcome, start_min=start_min
            )

        for a_player in away_players:
            update_player_stats(
                a_player, is_home=False, outcome=outcome, start_min=start_min
            )
